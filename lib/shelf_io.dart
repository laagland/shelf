...
//Future<HttpServer> serveSecure(Handler handler, address, int port,
//    {int backlog, bool requestClientCertificate: false}) {

Future<HttpServer> serveSecure(Handler handler, address, int port, SecurityContext context,
    {int backlog, bool v6Only, bool requestClientCertificate, bool shared}) {

    if (backlog == null) backlog = 0;
    if (v6Only == null) v6Only = false;
    if (requestClientCertificate == null) requestClientCertificate = false;
